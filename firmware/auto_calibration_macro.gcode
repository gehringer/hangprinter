G95 A1 B1 C1 D1 F5000 ; Set all motors in torque mode and drag close to origo
G4 P2000              ; Dwell for 2000 ms
G28                   ; Assure that line lengths are re-calculated to match origo. Printer should be within ca 10 cm of origo.
